                    ...
                    @foreach ($categories as $categorie)
                        <div class="col-lg-4 col-xl-3 col-md-6">
                            <div class="single_catagory">
                                <a href="jobs.html">
                                    <h4 class="pb-2">{{ $categorie->cat_name }}</h4>
                                </a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                <p>{{ Str::words($featured_job->description, 10) }}</p>
                                                <div class="bg-light p-3 border">
                                                    ...
                                                    <p class="mb-0">
                                                        ...
                                                        <span class="ps-1">{{ $featured_job->jobtype_name }}</span>
                                                    </p>
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p>{{ Str::words($latest_job->description, 10) }}</p>
                                            <div class="bg-light p-3 border">
                                                <p class="mb-0">
                                                    <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
                                                ...
                                                <p class="mb-0">
                                                    <span class="fw-bolder"><i class="fa fa-clock-o"></i></span>
                                                    <span class="ps-1">{{ $latest_job->jobtype_name }}</span>
                                                </p>
